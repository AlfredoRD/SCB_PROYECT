...
export default async function SobreNosotrosPage() {
  ...
  if (!session) {
    redirect("/login?redirect=/admin/contenido/sobre-nosotros")
  }
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-3xl font-bold">Editar Contenido: Sobre Nosotros</h1>
      ...
      <div className="bg-card border rounded-lg p-6">
        ...
        <p className="text-muted-foreground mb-6">
          Aquí puedes editar la información general, nuestra historia, misión, visión y valores.
        </p>
